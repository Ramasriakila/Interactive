...
<body>
    ...
    <div style="white-space: nowrap; overflow-x: auto; padding: 1rem;">
        <div style="display: inline-block; margin-right: 10px;" onclick="openModal(this)">
            <img src="ri.png" style="height: 200px;">
        </div>
        <div style="display: inline-block; margin-right: 10px;" onclick="openModal(this)">
            <img src="mi.png" style="height: 200px;">
        </div>
        <div style="display: inline-block; margin-right: 10px;" onclick="openModal(this)">
            <img src="life.png" style="height: 200px;">
        </div>
        <div style="display: inline-block;" onclick="openModal(this)">
            <img src="urave.png" style="height: 200px;">
        </div>
    </div>` 
...
```
## OUTPUT:
![Screenshot 2025-05-07 105904](https://github.com/user-attachments/assets/f757484c-c203-47bf-ae6c-90938decf72e)
![Screenshot 2025-05-07 105919](https://github.com/user-attachments/assets/bbbb82f8-de61-455a-8bb2-b93c94eb935b)
